...
const PlusIconWithColor: FC<PlusIconWithColorProps> = (props) => {
  ...
  return (
    <svg width="16" height="16" className={className} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M8.02001 3.33301L8.00781 12.6663" stroke={finalColor} strokeWidth="1.8" strokeLinejoin="round" />
      <path d="M3.33398 8H12.6673" stroke={finalColor} strokeWidth="1.8" strokeLinejoin="round" />
    </svg>
  )
