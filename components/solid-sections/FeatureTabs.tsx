  ...
  const tabs = [
      ...
      content: (
        <div className="flex items-center gap-8 lg:gap-19">
          <div className="md:w-1/2">
            <h2 className="text-black dark:text-white text-3xl xl:text-sectiontitle2 font-bold mb-7">Refundable & Transferable NFT.</h2>
    ...
    },
    {
      ...
      content: (
        <div className="flex items-center gap-8 lg:gap-19">
          <div className="md:w-1/2">
            <h2 className="text-black dark:text-white text-3xl xl:text-sectiontitle2 font-bold mb-7">One Resolver SDK for omnichain.</h2>
    ...
    },
    {
      ...
      content: (
        <div className="flex items-center gap-8 lg:gap-19">
          <div className="md:w-1/2">
            {/* 对用户免费 & 社区资金安全托管. */}
            <h2 className="text-black dark:text-white text-3xl xl:text-sectiontitle2 font-bold mb-7">One Brand NFT, For Anywhere, Anytime.</h2>
            {/* 面向社区成员完全免费. */}
  ...
  return (
    <section className="pt-18.5 pb-20 lg:pb-22.5 relative">
      <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
        ...
        {/* <!-- Tab Menues Start --> */}
        <div
          className="sr-item animate_top border border-stroke dark:border-strokedark dark:bg-blacksection shadow-solid-5 dark:shadow-solid-6 bg-white rounded-[10px] flex flex-wrap flex-col md:flex-row md:flex-nowrap md:items-center justify-center lg:gap-7.5 xl:gap-12.5 mb-15 xl:mb-21.5"
        >
          {
            tabs.map((tab, index) => (
              <div
                key={index}
                className={classnames('relative cursor-pointer flex-1 border-b last:border-0 md:border-0 border-stroke dark:border-strokedark flex items-center gap-4 py-2 xl:py-5 px-6 xl:px-13.5', {
              ...
              >
                ...
                <div className="flex-1 lg:w-auto md:w-3/5">
                  <h5 className="text-black dark:text-white text-sm xl:text-regular font-medium">{ tab.title }</h5>
                </div>
              </div>
            ))
          }
