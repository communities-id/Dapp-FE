...
const BaseButton: FC<Props> = ({ size = 'auto', disabled, loading, onClick, className, children }) => {
  return (
    <button
      disabled={disabled || loading}
      className={
        classnames(
          'flex-center !shadow-none disabled:opacity-50 disabled:cursor-not-allowed',
          {
