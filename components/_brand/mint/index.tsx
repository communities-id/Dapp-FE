...
import CommunityMintStatus from '@/components/_brand/mint/status'
import CommunityMintStart from '@/components/_brand//mint/register'
import CommunitySuccess from '@/components/_brand/mint/latest'
    ...
    <div className='w-full h-full'>
      {
        step === 0 && (
          <CommunityMintStatus
            ...
            step={<Steps className='mt-[30px] px-15' step={0} steps={steps}/>}
          >
            <Fragment>
      ...
      }
      {
        step === 1 && (
          <CommunityMintStart
            ...
            step={<Steps className='mt-[30px] px-15' step={1} steps={steps}/>}
          >
            <Fragment>
              <ul className='flex flex-col gap-[7px] w-full'>
                {
